...
const BALL_RADIUS=6.7;//+++++++++++++++++++++++++++++++6.7
const SCORE_UNIT = 1;
const MAX_LEVEL = 6;
const segmant=7;
const dmbr=12.1;//++++++++++++++++++++++++12.1
...
//enter
function enter1(){
    if(document.fullscreenElement==null && vrb>4 && vrb1>=3 && GAME_OVER!=true && orientLL==false ){
